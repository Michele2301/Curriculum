...
import {editContentById, getContentById} from "../API.js";
const schema = Yup.object().shape({
    type: Yup.string().required('Required'),
    content: Yup.string().required('Required'),
});
export default function EditContentFields(){
    const nav=useNavigate();
    const contentId=parseInt(useParams().contentId);
    ...
    useEffect(()=>{
        setUpdating(true);
        getContentById(pageId,contentId).then((p)=>{
            ...
            <Row>
                <Formik
                    ...
                    onSubmit={async values => {
                        setUpdating(true);
                        try{
                            await editContentById(pageId,contentId,values.type,values.content);
