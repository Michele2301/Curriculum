...
def plot_graph():
    ...
    plt.plot(first['Timestamp'], first['Requests/s']-first["Failures/s"], label='Local', marker='o')
    plt.plot(second['Timestamp'], second['Requests/s']-second["Failures/s"], label='Azure VMSS', marker='o')
    plt.plot(third['Timestamp'], third['Requests/s']-third["Failures/s"], label='Azure Web App', marker='o')
    plt.plot(fourth['Timestamp'], fourth['Requests/s']-fourth["Failures/s"], label='Azure Function', marker='o')
